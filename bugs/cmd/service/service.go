...
import (
	...
	endpoint "github.com/ibadi-id/packagemain/bugs/pkg/endpoint"
	http1 "github.com/ibadi-id/packagemain/bugs/pkg/http"
	service "github.com/ibadi-id/packagemain/bugs/pkg/service"
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		endpoint, err := zipkingo.NewEndpoint("bugs", "localhost:80")
		if err != nil {
			logger.Log("err", err)
			os.Exit(1)
		}
